...
################################################URL FASE################################################################
    ...
    url(r'^administracion/proyectos/(?P<id_proyecto>\d+)/fases/(?P<id_fase>\d+)/iniciar/$', 'administracion.views.confirmar_iniciar_fase'),
    url(r'^administracion/proyectos/(?P<id_proyecto>\d+)/fases/(?P<id_fase>\d+)/iniciada/$', 'administracion.views.iniciar_fase'),
    url(r'^administracion/proyectos/(?P<id_proyecto>\d+)/fases/(?P<id_fase>\d+)/finalizar/$', 'administracion.views.confirmar_finalizar_fase'),
    url(r'^administracion/proyectos/(?P<id_proyecto>\d+)/fases/(?P<id_fase>\d+)/finalizada/$', 'administracion.views.finalizar_fase'),
...
########################################################################################################################
    ...
    url(r'^gestion/reporte/(?P<id_proyecto>\d+)/proyecto/$', 'gestion.views.reporte_proyecto'),
    url(r'^gestion/reporte/(?P<id_proyecto>\d+)/solicitud/$', 'gestion.views.reporte_solicitud'),
    ...
    url(r'^gestion/proyecto/(?P<id_proyecto>\d+)/solicitudes/(?P<id_solicitud>\d+)/item/(?P<id_item>\d+)/$', 'gestion.views.solicitud_item'),
